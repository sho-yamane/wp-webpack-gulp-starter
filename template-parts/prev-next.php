			...
			<?php else : ?>
				...
				<div class="prev prev-next">
					<?php
						previous_post_link(
							'%link',
							'<div class="post-thumbnail" style="background-image: url(' . esc_url( get_theme_file_uri( '/img/no-image.jpg' ) ) . ')"></div><i class="fa fa-caret-left" aria-hidden="true"></i> <p class="post-title">%title</p>'
						);
					?>
				</div>
			...
			<?php else : ?>
				...
				<div class="next prev-next">
					<?php
						next_post_link(
							'%link',
							'<div class="post-thumbnail" style="background-image: url(' . esc_url( get_theme_file_uri( '/img/no-image.jpg' ) ) . ')"></div><i class="fa fa-caret-right" aria-hidden="true"></i> <p class="post-title">%title</p>'
						);
					?>
				</div>
